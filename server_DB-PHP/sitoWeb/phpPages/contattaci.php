    ...
    <div class="container-fluid">
        <div class="row" id="rowNavbar">
            <div class="col">
                ...
                <a class="linkNavbar" href="http://<?php echo $IP; ?>:3000/accedi"><b>Accedi</b></a>
                <a class="linkNavbar" href="http://<?php echo $IP; ?>:3000/registrati"><b>Registrati</b></a>
            </div>
        </div>
        <div class="row">
        ...
        <div class="row">
            ...
            <div class="col-12 col-lg-6 column">
                ...
                <form action="http://<?php echo $IP; ?>:80/progetti/CrazyGoose/server_DB-PHP/phpFiles/send.php" method="post" name="formContattaci" onsubmit="return(controllaDati())">
                    <div class="divVoce">
                        <label>Nome:</label>
