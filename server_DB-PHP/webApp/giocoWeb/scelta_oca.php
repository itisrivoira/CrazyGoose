...
<body style="margin:0px;">
    <div id="areaScelta">
        ...
        <center>
            <div id="areaOche">
                <a href="http://<?php echo $IP; ?>:80/progetti/CrazyGoose/server_DB-PHP/webApp/giocoWeb/scelta_oca.php?ocaScelta=gialla">    
                ...
                <a href="http://<?php echo $IP; ?>:80/progetti/CrazyGoose/server_DB-PHP/webApp/giocoWeb/scelta_oca.php?ocaScelta=verde">    
                ...
                <a href="http://<?php echo $IP; ?>:80/progetti/CrazyGoose/server_DB-PHP/webApp/giocoWeb/scelta_oca.php?ocaScelta=blu">    
                ...
                <a href="http://<?php echo $IP; ?>:80/progetti/CrazyGoose/server_DB-PHP/webApp/giocoWeb/scelta_oca.php?ocaScelta=rossa">
...
<?php 
        ...
        header("Location: http://$IP:3000/gioco");
    }
?>
